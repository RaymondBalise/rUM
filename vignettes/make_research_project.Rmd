...
You will now have a new project directory created and it will be populated with these files:
...
* `the-new-england-journal-of-medicine.csl` **TO DO: ADD EXPLANATION!!**
