...
You will now have a new project directory created and it will be populated with [these files](created_rUM_files.png):

* An aggressive `.gitignore` to prevent the inadvertent sharing of study subject protected health information (PHI).
* [`analysis.Rmd`](analysis_markdown.png) is a markdown boilerplate for writing your research project. It has a preconfigured YAML header; setup chunk; Introduction, Methods, Results, Conclusion, and Reference sections; and a code chunk to construct your bibliography using `knitr::write_bib()`.
...
![](created_rUM_files.png){width=50%}
  
`analysis.Rmd`:

![](analysis_markdown.png){width=70%}
