---
title: "Create a Research Project with Quarto and rUM"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Create a Research Project with Quarto and rUM}
...
3.  Specify the location of where your research project will be saved
    ...
    ![](save_quarto_project_here.png){width="70%" alt='Quarto save location prompt'}
...
```
![](created_rUM_quarto_files.png){width="80%" alt='List of newly-created project files'}
...
```
![](analysis_quarto_file.png){width="80%" alt='analysis.qmd template display'}
