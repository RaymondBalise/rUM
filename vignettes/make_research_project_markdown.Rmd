---
title:  "Create a Research Project with R Markdown and rUM"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Create a Research Project with R Markdown and rUM}
...
2.  Scroll down and then select **`rUM` Research Project Template**
    ...
    ![](project_template.png){width=70% alt='New Project Wizard template'}

3.  Specify the location of where your research project will be saved

    ![](save_markdown_project_here.png){width=70% alt='RMarkdown save location prompt'}
...
2.  Specify the location of where your research project will be saved
    ...
    ![](existing_directory.png){width=70% alt='Location of where to save new research project'}
...
```    
![](created_rUM_markdown_files.png){width=70% alt='List of newly-created project files'}
...
``` 
![](analysis_Rmd_file.jpg){width=80% alt='analysis.Rmd template display'}
...
1. Navigate to File > New File > R Markdown
    ...
    ![](newfile_markdown.jpg){width=70% alt='How to use rUM markdown headers in RStudio'}

1. Select **From Template**

    ![](from_template.png){width=70% alt='Select "html2 with rUM" template from dropdown'}
