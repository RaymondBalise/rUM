...
When you use the `template = "rmed2025"` argument to `write_slides()` you get a folder called **img** in the slides folder.  It contains a html file you don't want to touch and a few image files that you will replace with your own files.
...
1. Replace the rmed_background.png file with the background image you would like on the title slide.  Change this line to reflect your file's name:  
`data-background-image: "img/rmed_background.png"`
2. Replace the rmed.png file with the logo you would like to appear in the bottom right corner of your slides.  Change this line to reflect your file's name:  
`logo: "img/rmed.png"`
3. Change this like so the hyperlink details point to where people can find your slides:  
`footer: "[Slides are here](https://){target='_blank'}"  # complete the URL`
4. Replace the rmed.ico file with the image that you would like to appear on browser tabs.  Be sure your image is square that is 32x32 pixels or larger and convert it to ico format with a tool like Preview on Mac.  Change this line to reflect your ico file name:  
